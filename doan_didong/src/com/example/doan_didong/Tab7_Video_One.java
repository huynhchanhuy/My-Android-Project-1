...
public class Tab7_Video_One extends Activity 
{
    ...
    public void onCreate(Bundle savedInstanceState) 
    {
       ...
       setContentView(R.layout.tab7_video_one);
       ...
       video = (VideoView) findViewById(R.id.tab7_video_one_view);
       video_id = (TextView)findViewById(R.id.tab7_video_one_id);
       video_title = (TextView)findViewById(R.id.tab7_video_one_title);
       video_link  =(TextView)findViewById(R.id.tab7_video_one_link);
       video_ngay_tao =(TextView)findViewById(R.id.tab7_video_one_ngay_tao);
       video_luot_view=(TextView)findViewById(R.id.tab7_video_one_luot_view);
       video_btnplay = (Button)findViewById(R.id.tab7_video_one_btn_play);
       video_yeuthich = (CheckBox)findViewById(R.id.tab7_video_one_yeuthich);
       video_one_information=(RelativeLayout)findViewById(R.id.tab7_video_one_information);
    ...
    class PrepareVideoProgress extends AsyncTask<String, String, Void> 
    {
        ...
        protected void onPreExecute() {
            dialog = new ProgressDialog(Tab7_Video_One.this);
    ...
    class Load_Video_One_Progress extends AsyncTask<String, String, String> 
	{
		...
		protected void onPreExecute() {
			super.onPreExecute();
			success = 0;
			pDialog = new ProgressDialog(Tab7_Video_One.this);
