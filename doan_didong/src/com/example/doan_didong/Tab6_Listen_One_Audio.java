...
public class Tab6_Listen_One_Audio extends Activity implements OnCompletionListener, SeekBar.OnSeekBarChangeListener
{
...
//	private boolean isShuffle = false;
	...
	public void onCreate(Bundle savedInstanceState) {
		...
		setContentView(R.layout.tab6_listen_one_audio);
		...
		audio_id = (TextView) findViewById(R.id.tab6_one_id);
		audio_title = (TextView) findViewById(R.id.tab6_one_title);
		audio_text  =  (TextView) findViewById(R.id.tab6_one_text);
		audio_link = (TextView) findViewById(R.id.tab6_one_link);
		audio_ngay_tao = (TextView) findViewById(R.id.tab6_one_ngay_tao);
		audio_luot_view = (TextView) findViewById(R.id.tab6_one_luot_view);
		audio_songCurrentDurationLabel = (TextView) findViewById(R.id.songCurrentDurationLabel);
		audio_totalsongDurationLabel = (TextView) findViewById(R.id.songTotalDurationLabel);
		audio_yeuthich = (CheckBox) findViewById(R.id.tab6_one_yeuthich);
		
		audio_btntext = (ImageButton) findViewById(R.id.tab6_one_btntext);
		audio_repeat = (ImageButton) findViewById(R.id.tab6_one_btnRepeat);
		audio_play = (ImageButton) findViewById(R.id.btnPlay);
		audio_backward = (ImageButton) findViewById(R.id.btnBackward);
		audio_forward = (ImageButton) findViewById(R.id.btnForward);
		Scroll_text_hidden = (ScrollView) findViewById(R.id.songThumbnail);
		audio_progressBar = (SeekBar) findViewById(R.id.songProgressBar); 
		try{
...
//		} 
	...
	class Listen_One_AudioProgress extends AsyncTask<String, String, String> 
	{
		...
		protected void onPreExecute() {
			super.onPreExecute();
			success = 0;
			pDialog = new ProgressDialog(Tab6_Listen_One_Audio.this);
